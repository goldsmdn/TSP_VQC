...
def set_up_input_hot_start(
    ...
    if print_results:
        ...
        print(
            f'The hot start distance is {sdl.hot_start_dist:.2f}, compared to a best distance of {sdl.best_dist:.2f}.'
        )
    return (unrepeated_input, my_input)
